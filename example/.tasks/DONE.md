...
## TASK-008: Add search by tag in filtered list
**Priority:** P3 | **Tags:** ui, feature

Extend the filtered task list to support filtering by tag. Add a tag dropdown or multi-select to the filter bar.
