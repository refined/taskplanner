...
Create a WebviewPanel with columns per state. Support HTML5 drag-and-drop to move tasks between columns. Include "Move to" button fallback for accessibility.
